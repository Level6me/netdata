...
_WebResourceData_WebResourceMIMEType_WebResourceTextEncodingName^WebResourceURL_WebResourceFrameNameOÖÈ<html><head></head><body><pre style="word-wrap: break-word; white-space: pre-wrap;">#!/usr/bin/env bash
...
exit 0
</pre></body></html>Ztext/plainUUTF-8_ihttps://raw.githubusercontent.com/netdata/netdata/master/packaging/installer/install-required-packages.shP    ( : P n } ”×`×k×q×Ý                           ×Þ